...
// Tipe data untuk input form, sudah menyertakan 'role'
...
const Register = () => {
  ...
  const {
    ...
    // Menetapkan nilai default untuk role saat form pertama kali dimuat
    defaultValues: {
      role: 'user'
    }
  });
  ...
  const handleRegister = async (data: RegisterInput) => {
    try {
      // Mengirim semua data, termasuk 'role', ke endpoint registrasi
  ...
  // Menggunakan useMutation dari TanStack Query untuk menangani state async
